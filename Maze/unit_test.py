...
def create_maze(maze_type):
    ...
    if maze_type == 0:
        ...
        myMazeStruct.max_rec_depth = 297
...
class UnitTestTemplate(unittest.TestCase):
    ...
    strHorLine = "------------------------------------------------------------\n"
    strFileHeader = f"ALGORITHMS AND DATA STRUCTURES 1 AI - {strAssignment}\n({date.today()})\n{strHorLine}\n"
    ...
    def test_two_exits(self):
        ...
        # check found exit
        self.check_exits("ERROR Test with 2 exits failed: Exits found @: ", myMazeStruct.list_of_exits, maze.exits,
                         maze._maze)
    ...
    def test_split_maze_with_two_exits(self):
        ...
        # check found exit
        self.check_exits("ERROR Test split maze failed: ", myMazeStruct.list_of_exits, maze.exits,
                         maze._maze)
    ...
    def test_big_maze_one_exit(self):
        ...
        # check found exit
        self.check_exits("Error in Test big maze with one exit failed: ", myMazeStruct.list_of_exits, maze.exits,
                         maze._maze)

    def test_min_maze_with_four_exits(self):
        maze, myMazeStruct = analyze_maze(4)
        # check found exit
        self.check_exits("Error in 'find_exits()' Test minimal maze with four exits failed: ",
                         myMazeStruct.list_of_exits, maze.exits,
                         maze._maze)

    def test_invalid_maze1(self):
        ex = None
        try:
            maze = Maze('')
        except ValueError as v:
            ex = v
        self.assertTrue(isinstance(ex, ValueError), "ERROR Empty maze did not raise ValueError")
    ...
    def test_maze_map_multiple_exits(self):
        maze, myMazeStruct = analyze_maze(11)
